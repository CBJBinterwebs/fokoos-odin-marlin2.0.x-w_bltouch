 ...
 *
 */
//ADDED DISPLAY TEMPERATURES FOR FOKOOS ODIN UI !!
...
void lv_draw_move_motor(void) {
  ...
  labelP = lv_label_create(scr, 400, 3, "Z:0.0mm");  // !! experimental position !!
