...
void tft_style_init() {
  ...
  tft_style_label_pre.text.font       = TERN(HAS_SPI_FLASH_FONT, &gb2312_puhui32, LV_FONT_DEFAULT);  //CHANGED FROM 'TERN(HAS_SPI_FLASH_FONT, &gb2312_puhui32, LV_FONT_DEFAULT);' 3-8-2022 !!
  ...
  style_num_key_rel.text.sel_color  = LV_COLOR_TEXT;
    ...
    style_num_key_pre.text.font = &gb2312_puhui32;  //was &gb2312_puhui32 !!
    style_num_key_rel.text.font = &gb2312_puhui32;  //was &gb2312_puhui32 !!
  #else
  ...
  style_num_text.text.font         = TERN(HAS_SPI_FLASH_FONT, &gb2312_puhui32, LV_FONT_DEFAULT);  //LV_FONT_DEFAULT !!
  ...
  style_sel_text.text.font        = &gb2312_puhui32;  //was &gb2312_puhui32 !!
  ...
  style_para_value.text.font         = &TERN(HAS_SPI_FLASH_FONT, gb2312_puhui32, lv_font_roboto_22);  //CHANGED FROM lv_font_roboto_22 3-8-2022 !!
  ...
  style_para_back.text.font         = &TERN(HAS_SPI_FLASH_FONT, gb2312_puhui32, lv_font_roboto_22);  //CHANGED FROM lv_font_roboto_22 3-8-2022 !!
  ...
  style_btn_rel.text.font         = &TERN(HAS_SPI_FLASH_FONT, gb2312_puhui32, lv_font_roboto_22);  //CHANGED FROM lv_font_roboto_22 3-8-2022 !!
  ...
  style_btn_pr.text.font         = &TERN(HAS_SPI_FLASH_FONT, gb2312_puhui32, lv_font_roboto_22);  //CHANGED FROM lv_font_roboto_22 3-8-2022 !!
  ...
  switch (disp_state) {
    ...
    case PRINT_READY_UI:
      ...
      case BLTOUCH_UI:
        if (temps_update_flag) {
          temps_update_flag = false;
          disp_ext_temp_bltouch_settings();
          disp_bed_temp_bltouch_settings();
          //lv_temp_refr();
        }
        break;
    #endif
...
void lv_draw_return_ui() {
  if (disp_state_stack._disp_index > 0) {
    ...
    switch (disp_state_stack._disp_state[disp_state_stack._disp_index]) {
      ...
      #endif
      case MORE_UI:                     lv_draw_tool(); break;
